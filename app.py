...
lineaccesstoken = 'YeQRd3XSBixRo4sTDvYOD4ahJohufjyS/N8+0J/tML8YQUnRn0hKT/NJ+DOaianleWPoX6G9MUniXdSnaJwdQ/IZhI1NPxe1/gKUcFb/gevJxayHSq5NTlUPumhISdsWaPfuekW9B8Z4Y0LdzneCPgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if  msg == "สวัสดี" :
             replyObj = TextSendMessage(text="เอาจริงดิ")
        elif msg == "เอาแล้วทำไหม" :
            replyObj = TextSendMessage(text="ไอสัส")
        elif msg == "เอาจริงดิ" :
             replyObj = TextSendMessage(text="อา")
        else  :      
            replyObj = TextSendMessage(text="ไม่รู้ไอโง่")
        line_bot_api.reply_message(rtoken, replyObj)
    elif msgType == "image":
        try:
